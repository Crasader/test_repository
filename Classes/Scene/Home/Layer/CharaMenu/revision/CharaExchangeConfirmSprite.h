#ifndef __war__CharaExchangeConfirmSprite__
#define __war__CharaExchangeConfirmSprite__
...
class CharaExchangeConfirmSprite : public Sprite
{
private:
...
public:
    ...
    CharaExchangeConfirmSprite(); //コンストラクタ
    
    static CharaExchangeConfirmSprite* create(Json json);
...
#endif /* defined(__war__CharaExchangeConfirmSprite__) */
