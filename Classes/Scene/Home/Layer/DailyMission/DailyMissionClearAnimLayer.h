#ifndef __war__DailyMissionClearAnimLayer__
#define __war__DailyMissionClearAnimLayer__
...
class DailyMissionClearAnimLayer : public cocos2d::Layer
{
private:
    enum Tag{
        T_Popup = 1,
...
public:
    ...
    static DailyMissionClearAnimLayer* create(string reward_item_type, string reward_related_id, string comment, string count, string chara_name, bool all_complate_anim_flg);
...
#endif /* defined(__war__DailyMissionClearAnimLayer__) */
