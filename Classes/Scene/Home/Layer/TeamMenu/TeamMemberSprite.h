#ifndef __War__TeamMemberSprite__
#define __War__TeamMemberSprite__
...
class TeamMemberSprite : public Sprite
{
private:
...
public:
    ...
    static TeamMemberSprite* create(json11::Json json, int count);
    virtual bool init(json11::Json json, int count);
    
    void onEnter(); //初期実行関数
};

#endif /* defined(__War__TeamMemberSprite__) */
