#ifndef __War__TeamMemberDetailSprite__
#define __War__TeamMemberDetailSprite__
...
class TeamMemberDetailSprite : public Sprite
{
private:
...
public:
    TeamMemberDetailSprite(); //コンストラクタ
    float ratio;
    
    static TeamMemberDetailSprite* create();
    virtual bool init();
...
#endif /* defined(__War__TeamMemberDetailSprite__) */
