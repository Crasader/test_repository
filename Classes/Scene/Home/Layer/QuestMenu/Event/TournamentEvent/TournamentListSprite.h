#ifndef __war__TournamentListSprite__
#define __war__TournamentListSprite__
...
class TournamentListSprite : public Sprite
{
private:
...
public:
    ...
    TournamentListSprite(); //コンストラクタ
    
    static TournamentListSprite* create(json11::Json json, Node* normal_scene);
...
#endif /* defined(__war__TournamentListSprite__) */
