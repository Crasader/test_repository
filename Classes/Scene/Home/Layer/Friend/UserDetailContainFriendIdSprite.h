#ifndef __War__UserDetailContainFriendIdSprite__
#define __War__UserDetailContainFriendIdSprite__
...
class UserDetailContainFriendIdSprite : public Sprite
{
private:
...
public:
    UserDetailContainFriendIdSprite(); //コンストラクタ
    float ratio;
    
    static UserDetailContainFriendIdSprite* create();
    virtual bool init();
...
#endif /* defined(__War__UserDetailContainFriendIdSprite__) */
