...
UserDetailSprite::UserDetailSprite()
:_user_master_id()
,_friend_id()
,_user_name()
,_user_comment()
...
UserDetailSprite* UserDetailSprite::create(){
    
    UserDetailSprite *sprite = new UserDetailSprite();
...
void UserDetailSprite::setupUserData(Json json)
{
    //ユーザデータの保存
...
void UserDetailSprite::createFriendCard()
{
    //フレンドカードの作成
...
void UserDetailSprite::createFriendId()
{
    //フレンドIDの作成
...
void UserDetailSprite::showUserData()
{
    //フレンドカードの作成
    createFriendCard();
