#ifndef __war__BazaarSelectRarelityButton__
#define __war__BazaarSelectRarelityButton__
...
class BazaarSelectRarelityButton : public MenuItemSprite
{
private:
...
public:
    float ratio;
    static BazaarSelectRarelityButton* Create(string imagePath1, string imagePath2 , BazaarSearchListLayer* layer);
