#ifndef __war__BazaarCardDetailLayer__
#define __war__BazaarCardDetailLayer__
...
class BazaarCardDetailLayer: public Layer
{
private:
...
public:
    ...
    BazaarCardDetailLayer(); //コンストラクタ
    
    static BazaarCardDetailLayer* create(string chara_id, string chara_list_id = "");
...
#endif /* defined(__war__BazaarCardDetailLayer__) */
