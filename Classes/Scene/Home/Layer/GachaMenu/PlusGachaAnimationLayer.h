#ifndef __war__PlusGachaAnimationLayer__
#define __war__PlusGachaAnimationLayer__
...
class PlusGachaAnimationLayer : public cocos2d::Layer, public SuperAnim::SuperAnimNodeListener
{
private:
...
public:
    ...
    virtual bool init();
    CREATE_FUNC(PlusGachaAnimationLayer);
...
#endif /* defined(__war__PlusGachaAnimationLayer__) */
