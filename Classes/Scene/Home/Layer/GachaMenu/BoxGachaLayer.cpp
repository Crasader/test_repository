...
void BoxGachaLayer::setupButton()
{
    ...
    //宝玉表示
    //1連
    img = Sprite::create("download/Gacha/jewel_1.png");
    img->setScale(ratio);
    img->setPosition(convertFromDisplaySize(Point(200, 335), 0.5, 0.5));
    this->addChild(img);
    
    //10連
    img = Sprite::create("download/Gacha/jewel_10.png");
    img->setScale(ratio);
    img->setPosition(convertFromDisplaySize(Point(200, 245), 0.5, 0.5));
    this->addChild(img);
    
    //30連
    img = Sprite::create("download/Gacha/jewel_30.png");
    img->setScale(ratio);
    img->setPosition(convertFromDisplaySize(Point(200, 155), 0.5, 0.5));
    this->addChild(img);
     */
