#ifndef __war__GachaResultLayer__
#define __war__GachaResultLayer__
...
class GachaResultLayer : public cocos2d::Layer, public SuperAnim::SuperAnimNodeListener, public ScrollViewDelegate
{
private:
...
#endif /* defined(__war__GachaResultLayer__) */
