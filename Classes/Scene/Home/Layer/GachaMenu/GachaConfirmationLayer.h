#ifndef __war__GachaConfirmationLayer__
#define __war__GachaConfirmationLayer__
...
class GachaConfirmationLayer : public Layer
{
private:
    Size visibleSize;
...
public:
    ...
    virtual bool init(int gacha_type);
    static GachaConfirmationLayer* create(int gacha_type);
...
#endif /* defined(__war__GachaConfirmationLayer__) */
