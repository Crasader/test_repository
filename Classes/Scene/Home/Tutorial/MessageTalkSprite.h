#ifndef __War__MessageTalkSprite__
#define __War__MessageTalkSprite__
...
class MessageTalkSprite : public cocos2d::Sprite
{
private:
private:
    Label *talk_label ;
...
public:
    ...
    static MessageTalkSprite* create();
    virtual bool init();
...
#endif /* defined(__War__MessageTalkSprite__) */
