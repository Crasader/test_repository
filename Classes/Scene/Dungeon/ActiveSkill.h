...
public:
	...
	//バフ処理(戦闘力UP/DOWN、貫通等)
    void statusBuffer(Chara* used_chara, int skill_id, int skill_value, int use_index, string target_type, string extra_data, float invoke_turn, int state=0, bool probability_flg = false);
