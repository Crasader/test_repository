#ifndef __War__BossEventPopupSprite__
#define __War__BossEventPopupSprite__
...
class BossEventPopupSprite : public Layer
{
private:
    ...
    string boss_event_stage_log_id;
...
public:
    ...
    BossEventPopupSprite(); //コンストラクタ
    
    static BossEventPopupSprite* create(Json json);
...
#endif /* defined(__War__BossEventPopupSprite__) */
