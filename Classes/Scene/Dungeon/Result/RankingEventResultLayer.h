#ifndef __war__RankingEventResultLayer__
#define __war__RankingEventResultLayer__
...
class RankingEventResultLayer : public Layer
{
private:
    
    enum RankingEventResultLayerTag{
        TAG_MENU_ITEM,
    };
...
public:
    ...
    RankingEventResultLayer(); //コンストラクタ
    
    static RankingEventResultLayer* create(bool winner_flg, string from_page_name = "DungeonScene");
    ...
    void showRankingEventResultLabel(float dt); //バトル結果のラベル画像の表示
    void showBattleRankingEventResult(); //対戦結果の表示
...
#endif /* defined(__war__RankingEventResultLayer__) */
