...
bool StampLayer::init()
{
    ...
    listener->onTouchBegan = CC_CALLBACK_2(StampLayer::onTouchBegan, this);
    listener->onTouchMoved = CC_CALLBACK_2(StampLayer::onTouchMoved, this);
    listener->onTouchEnded = CC_CALLBACK_2(StampLayer::onTouchEnded, this);
    ...
    //背景
    bg = Sprite::create("download/Dungeon/bk.png");
    bg->setScale(ratio);
    ...
    //スクロールの作成
    stamp_scroll = StampScroll::create();
...
bool StampLayer::onTouchBegan(cocos2d::Touch *touch, cocos2d::Event *event)
{
...
void StampLayer::onTouchMoved(cocos2d::Touch *touch, cocos2d::Event *event)
{
}


void StampLayer::onTouchEnded(cocos2d::Touch *touch, cocos2d::Event *event)
{
